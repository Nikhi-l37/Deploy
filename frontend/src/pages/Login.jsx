      ...
      <div className="w-full max-w-md bg-[#161b22] border border-[#30363d] rounded-[6px] shadow-sm overflow-hidden">
        ...
        <div className="p-8 sm:p-10 flex flex-col items-center text-center">
          ...
          <button 
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-2.5 bg-[#238636] hover:bg-[#2ea043] active:bg-[#29903b] text-white font-medium py-2.5 px-4 rounded-[6px] border border-[rgba(240,246,252,0.1)] shadow-[0_1px_0_rgba(27,31,36,0.1)] transition-colors text-sm disabled:opacity-50 select-none cursor-pointer"
          >
        ...
        <div className="px-6 py-3 bg-[#161b22] border-t border-[#30363d] flex items-center justify-between text-xs text-[#8b949e]">
          ...
          <span className="font-mono text-[11px] text-[#484f58]">OAuth 2.0</span>
        </div>
