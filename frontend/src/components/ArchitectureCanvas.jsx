  ...
  return (
    <div className="max-w-5xl mx-auto pt-8 w-full space-y-4">
      ...
      <div className="bg-[#080b10] border border-[#30363d] rounded-[10px] overflow-hidden shadow-2xl relative">
        ...
        <div className="relative w-full h-[530px] bg-[#080b10] bg-dot-grid overflow-hidden">
          ...
          {activeTab === 'user' && (
            <div className="w-full h-full relative animate-fade-in">
              <svg className="absolute inset-0 w-full h-full pointer-events-none z-0">
                ...
                <path d="M 125 300 L 125 185" fill="none" stroke="#21262d" strokeWidth="3" />
                <path d="M 125 300 L 125 185" fill="none" stroke="#388bfd" strokeWidth="1.5" strokeDasharray="4 4" />
                ...
                <path d="M 215 125 L 265 125" fill="none" stroke="#21262d" strokeWidth="3" />
                <path d="M 215 125 L 265 125" fill="none" stroke="#2ea44f" strokeWidth="1.5" strokeDasharray="4 4" />
                ...
                <path d="M 455 125 L 495 125" fill="none" stroke="#21262d" strokeWidth="3" />
                <path d="M 455 125 L 495 125" fill="none" stroke="#bc8cff" strokeWidth="1.5" strokeDasharray="4 4" />
                ...
                <path d="M 685 125 L 725 125" fill="none" stroke="#21262d" strokeWidth="3" />
                <path d="M 685 125 L 725 125" fill="none" stroke="#2ea44f" strokeWidth="1.5" strokeDasharray="4 4" />
                <circle r="4.5" fill="#2ea44f" filter="url(#glow-green-dev)">
              ...
              <div className="absolute left-4 sm:left-6 top-[295px] w-[175px] sm:w-[190px] bg-[#161b22]/95 backdrop-blur-md border border-[#30363d] hover:border-[#58a6ff] hover:shadow-[0_0_15px_rgba(88,166,255,0.15)] rounded-[8px] p-3.5 space-y-2.5 z-10 shadow-lg cursor-pointer group transition-all duration-200">
                <div className="flex items-center gap-2.5">
              ...
              <div className="absolute left-4 sm:left-6 top-[55px] w-[175px] sm:w-[190px] bg-[#161b22]/95 backdrop-blur-md border border-[#30363d] hover:border-[#f0f6fc] hover:shadow-[0_0_15px_rgba(240,246,252,0.12)] rounded-[8px] p-3.5 space-y-2.5 z-10 shadow-lg cursor-pointer group transition-all duration-200">
                <div className="flex items-center gap-2.5">
              ...
              <div className="absolute left-[24%] sm:left-[26%] top-[55px] w-[185px] sm:w-[200px] bg-[#161b22] border-2 border-[#2ea44f]/70 hover:border-[#2ea44f] shadow-[0_0_20px_rgba(46,164,79,0.15)] rounded-[8px] p-3.5 space-y-2.5 z-10 cursor-pointer group transition-all duration-200">
              ...
              <div className="absolute left-[48%] sm:left-[51%] top-[55px] w-[185px] sm:w-[200px] bg-[#161b22]/95 backdrop-blur-md border border-[#30363d] hover:border-[#bc8cff] hover:shadow-[0_0_15px_rgba(188,140,255,0.15)] rounded-[8px] p-3.5 space-y-2.5 z-10 shadow-lg cursor-pointer group transition-all duration-200">
                <div className="flex items-center gap-2.5">
              ...
              <div className="absolute right-4 sm:right-6 top-[55px] w-[185px] sm:w-[205px] bg-[#161b22]/95 backdrop-blur-md border border-[#30363d] hover:border-[#2ea44f] hover:shadow-[0_0_20px_rgba(46,164,79,0.2)] rounded-[8px] p-3.5 space-y-2.5 z-10 shadow-lg cursor-pointer group transition-all duration-200">
                <div className="flex items-center gap-2.5">
              ...
              <div className="absolute left-[24%] sm:left-[26%] right-4 sm:right-6 top-[230px] sm:top-[245px] bg-[#161b22]/95 backdrop-blur-md border border-[#30363d] rounded-[8px] p-4 sm:p-5 space-y-3 shadow-lg select-none">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 text-left pt-1">
                  <div className="space-y-1">
                    ...
                    <p className="text-[10.5px] text-[#8b949e] leading-relaxed">Push to GitHub repository from your local IDE.</p>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10.5px] text-[#8b949e] leading-relaxed">Deployat pulls code and auto-generates Docker container.</p>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10.5px] text-[#8b949e] leading-relaxed">Secrets decrypted symmetrically and injected securely.</p>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10.5px] text-[#8b949e] leading-relaxed">Nginx routes live traffic to your app with SSL in seconds.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {activeTab === 'engine' && (
            <div className="w-full h-full relative animate-fade-in">
              <svg className="absolute inset-0 w-full h-full pointer-events-none z-0">
                ...
                <path d="M 215 110 C 275 110, 275 220, 335 220" fill="none" stroke="#21262d" strokeWidth="3" />
                <path d="M 215 110 C 275 110, 275 220, 335 220" fill="none" stroke="#58a6ff" strokeWidth="1.5" strokeDasharray="4 4" />
                ...
                <path d="M 215 380 C 275 380, 275 270, 335 270" fill="none" stroke="#21262d" strokeWidth="3" />
                <path d="M 215 380 C 275 380, 275 270, 335 270" fill="none" stroke="#3ECF8E" strokeWidth="1.5" strokeDasharray="4 4" />
                ...
                <path d="M 565 220 C 615 220, 615 110, 675 110" fill="none" stroke="#21262d" strokeWidth="3" />
                <path d="M 565 220 C 615 220, 615 110, 675 110" fill="none" stroke="#FF9900" strokeWidth="1.5" strokeDasharray="4 4" />
                <circle r="4.5" fill="#FF9900" filter="url(#glow-orange-engine)">
                  <animateMotion dur="2.3s" repeatCount="indefinite" path="M 565 220 C 615 220, 615 110, 675 110" />
                </circle>

                {/* Wire 4: Stage 3 (AWS Compute Host) ➔ Stage 5 (Resource Optimizer / Watchdog Loop) */}
                <path d="M 565 270 C 615 270, 615 380, 675 380" fill="none" stroke="#21262d" strokeWidth="3" />
                <path d="M 565 270 C 615 270, 615 380, 675 380" fill="none" stroke="#bc8cff" strokeWidth="1.5" strokeDasharray="4 4" />
                <circle r="4.5" fill="#bc8cff" filter="url(#glow-purple-engine)">
                  <animateMotion dur="2.7s" repeatCount="indefinite" path="M 565 270 C 615 270, 615 380, 675 380" />
                </circle>
              </svg>

              {/* STAGE 1: INGESTION & TRIGGER (Top-Left) */}
              <div className="absolute left-4 sm:left-6 top-[55px] w-[185px] sm:w-[200px] bg-[#161b22]/95 backdrop-blur-md border border-[#30363d] hover:border-[#58a6ff] hover:shadow-[0_0_15px_rgba(88,166,255,0.15)] rounded-[8px] p-3.5 space-y-2.5 z-10 shadow-lg cursor-pointer group transition-all duration-200">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <div className="w-7 h-7 rounded-[6px] bg-[#0d1117] border border-[#30363d] flex items-center justify-center p-1 text-[#f0f6fc]">
                      <BrandLogos.GitHub />
              ...
              <div className="absolute left-4 sm:left-6 top-[325px] w-[185px] sm:w-[200px] bg-[#161b22]/95 backdrop-blur-md border border-[#30363d] hover:border-[#3ECF8E] hover:shadow-[0_0_15px_rgba(62,207,142,0.15)] rounded-[8px] p-3.5 space-y-2.5 z-10 shadow-lg cursor-pointer group transition-all duration-200">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
              ...
              <div className="absolute left-[33%] sm:left-[35%] top-[160px] w-[225px] sm:w-[245px] bg-[#161b22] border-2 border-[#FF9900]/80 hover:border-[#FF9900] shadow-[0_0_25px_rgba(255,153,0,0.18)] rounded-[10px] p-4 space-y-3 z-20 cursor-pointer group transition-all duration-200">
              ...
              <div className="absolute right-4 sm:right-6 top-[55px] w-[185px] sm:w-[200px] bg-[#161b22]/95 backdrop-blur-md border border-[#30363d] hover:border-[#58a6ff] hover:shadow-[0_0_15px_rgba(88,166,255,0.15)] rounded-[8px] p-3.5 space-y-2.5 z-10 shadow-lg cursor-pointer group transition-all duration-200">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
              ...
              <div className="absolute right-4 sm:right-6 top-[325px] w-[185px] sm:w-[200px] bg-[#161b22]/95 backdrop-blur-md border border-[#30363d] hover:border-[#bc8cff] hover:shadow-[0_0_15px_rgba(188,140,255,0.15)] rounded-[8px] p-3.5 space-y-2.5 z-10 shadow-lg cursor-pointer group transition-all duration-200">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
